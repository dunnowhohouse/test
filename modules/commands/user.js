...
module.exports.languages = {
	"vi": {
		...
		"banSuccess": "Đã xử lý thành công yêu cầu cấm người dùng: %1",
		"unbanSuccess": "Đã xử lý thành công yêu cầu gỡ cấm người dùng %1",
		"banCommandSuccess": "Đã xử lý thành công yêu cầu cấm lệnh đối với người dùng: %1",
		"unbanCommandSuccess": "Đã xử lý thành công yêu cầu gỡ cấm %1 đối với người dùng: %2",
		...
		"existBan": "Người dùng %1 đã bị ban từ trước %2 %3",
		"notExistBan": "Người dùng bạn nhập chưa từng bị cấm sử dụng.",
		"missingCommandInput": "%1 Phần Command cần cấm không được để trống.",
		"notExistBanCommand": "Hiện tại ID người dùng bạn nhập chưa từng bị cấm sử dụng lệnh.",

		"returnBan": "Hiện tại bạn đang yêu cầu cấm người dùng:\n- ID và tên người dùng cần cấm: %1%2\n\nReaction tin nhắn này để xác thực.",
		"returnUnban": "Hiện tại bạn đang yêu cầu gỡ cấm người dùng:\n- ID và tên người dùng cần gỡ cấm: %1\n\nReaction tin nhắn này để xác thực.",
		"returnBanCommand": "Hiện tại bạn đang yêu cầu cấm sử dụng lệnh đối với người dùng:\n - ID và tên người dùng cần cấm: %1\n- Các lệnh cần cấm: %2\n\nReaction tin nhắn này để xác thực.",
		"returnUnbanCommand": "Hiện tại bạn đang yêu cầu gỡ cấm sử dụng lệnh đối với với người dùng:\n - ID và tên người dùng cần gỡ cấm lệnh: %1\n- Các lệnh cần gỡ cấm: %2\n\nReaction tin nhắn này để xác thực.",
	
		"returnResult": "Đây là kết quả phù hợp: \n",
		"returnNull": "Không tìm thấy kết quả dựa vào tìm kiếm của bạn.",
		"returnList": "Hiện tại đang có %1 người dùng bị ban, dưới đây là %2 người dùng\n\n%3",
		"returnInfo": "Đây là một sô thông tin về người dùng bạn cần tìm:\n- ID và tên của người dùng: %1n- Có bị ban?: %2 %3 %4\n- Bị ban lệnh?: %5"
	},
	"en": {
		"reason": "Reason",
		"at": "At",
